...
zend_class_entry *phalconator_cli_tool_ce;
zend_class_entry *phalconator_cli_tool_color_ce;
zend_class_entry *phalconator_cli_tool_menu_ce;
...
static PHP_MINIT_FUNCTION(phalconator)
{
	...
	ZEPHIR_INIT(Phalconator_Cli_Tool);
	ZEPHIR_INIT(Phalconator_Cli_Tool_Color);
	ZEPHIR_INIT(Phalconator_Cli_Tool_Menu);
...
static PHP_RINIT_FUNCTION(phalconator)
{
	...
	zephir_initialize_memory(phalconator_globals_ptr TSRMLS_CC);
		...
		zephir_init_static_properties_Phalconator_Cli_Tool_Color(TSRMLS_C);
