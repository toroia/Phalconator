...
#define ZEPHIR_CONCAT_VVVVS(result, op1, op2, op3, op4, op5) \
	 zephir_concat_vvvvs(result, op1, op2, op3, op4, op5, sizeof(op5)-1, 0);
#define ZEPHIR_SCONCAT_VVVVS(result, op1, op2, op3, op4, op5) \
	 zephir_concat_vvvvs(result, op1, op2, op3, op4, op5, sizeof(op5)-1, 1);
...
void zephir_concat_vvvvs(zval *result, zval *op1, zval *op2, zval *op3, zval *op4, const char *op5, zend_uint op5_len, int self_var);
