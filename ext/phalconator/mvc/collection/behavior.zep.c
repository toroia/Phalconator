...
ZEPHIR_INIT_CLASS(Phalconator_Mvc_Collection_Behavior) {
	...
	ZEPHIR_REGISTER_CLASS(Phalconator\\Mvc\\Collection, Behavior, phalconator, mvc_collection_behavior, phalconator_mvc_collection_behavior_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_declare_property_null(phalconator_mvc_collection_behavior_ce, SL("options"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(phalconator_mvc_collection_behavior_ce TSRMLS_CC, 1, phalconator_mvc_collection_behaviorinterface_ce);
	return SUCCESS;
