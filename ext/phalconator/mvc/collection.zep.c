...
ZEPHIR_INIT_CLASS(Phalconator_Mvc_Collection) {
	...
	zend_declare_property_null(phalconator_mvc_collection_ce, SL("connection"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("container"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(phalconator_mvc_collection_ce, SL("dirtyState"), 1, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("disableEvents"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("errorMessages"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("modelsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(phalconator_mvc_collection_ce, SL("operationMade"), 0, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("reserved"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("skipped"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalconator_mvc_collection_ce, SL("source"), ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	zend_class_implements(phalconator_mvc_collection_ce TSRMLS_CC, 1, zephir_get_internal_ce(SL("phalcon\\mvc\\entityinterface")));
...
PHP_METHOD(Phalconator_Mvc_Collection, __construct) {
	...
	zend_class_entry *_0$$3, *_3$$4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_5 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *container = NULL, container_sub, *modelsManager = NULL, modelsManager_sub, __$null, _1$$4, _2$$4, _4$$4, _6$$5;
	...
	if (Z_TYPE_P(container) != IS_OBJECT) {
		...
		ZEPHIR_CALL_CE_STATIC(container, _0$$3, "getdefault", NULL, 0);
		zephir_check_call_status();
	}
	if (UNEXPECTED(Z_TYPE_P(container) != IS_OBJECT)) {
		ZEPHIR_INIT_VAR(&_1$$4);
		object_init_ex(&_1$$4, zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")));
		_3$$4 = zephir_fetch_class_str_ex(SL("Phalcon\\Mvc\\Collection\\Exception"), ZEND_FETCH_CLASS_AUTO);
		ZEPHIR_INIT_VAR(&_4$$4);
		ZVAL_STRING(&_4$$4, "the services related to the ODM");
		ZEPHIR_CALL_CE_STATIC(&_2$$4, _3$$4, "containerservicenotfound", NULL, 0, &_4$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", &_5, 0, &_2$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalconator/Mvc/Collection.zep", 84 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (Z_TYPE_P(modelsManager) != IS_OBJECT) {
		...
		ZVAL_STRING(&_6$$5, "collectionManager");
		ZEPHIR_CALL_METHOD(modelsManager, container, "getshared", NULL, 0, &_6$$5);
		zephir_check_call_status();
		if (UNEXPECTED(Z_TYPE_P(modelsManager) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "The injected service 'modelsManager' is not valid", "phalconator/Mvc/Collection.zep", 97);
			return;
		}
	}
...
PHP_METHOD(Phalconator_Mvc_Collection, aggregate) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Method getSource() returns empty string", "phalconator/Mvc/Collection.zep", 143);
		return;
	}
...
PHP_METHOD(Phalconator_Mvc_Collection, cloneResult) {
	...
	zephir_is_iterable(&document, 0, "phalconator/Mvc/Collection.zep", 190);
...
PHP_METHOD(Phalconator_Mvc_Collection, create) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, data, status, collection, _0, _1, _2, _3, _4, _6, _10, _11, _12, _7$$5, _8$$5, _9$$4;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_read_static_property_ce(&_3, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (exists) {
		ZVAL_BOOL(&_4, 1);
	} else {
		ZVAL_BOOL(&_4, 0);
	}
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "presave", NULL, 1, &_0, &_3, &_4);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&status, &collection, "insertone", NULL, 0, &data, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_6, &status, "isacknowledged", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_6)) {
		success = 1;
		if (exists == 0) {
			ZEPHIR_CALL_METHOD(&_7$$5, &status, "getinsertedid", NULL, 0);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, SL("_id"), &_7$$5);
			ZEPHIR_INIT_ZVAL_NREF(_8$$5);
			ZVAL_LONG(&_8$$5, 0);
			zephir_update_property_zval(this_ptr, SL("dirtyState"), &_8$$5);
		}
		ZEPHIR_INIT_ZVAL_NREF(_9$$4);
		ZVAL_LONG(&_9$$4, 0);
		zephir_update_property_zval(this_ptr, SL("dirtyState"), &_9$$4);
	}
	zephir_read_static_property_ce(&_10, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (success) {
		ZVAL_BOOL(&_11, 1);
	} else {
		ZVAL_BOOL(&_11, 0);
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 2, &_10, &_11, &_12);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalconator_Mvc_Collection, createIfNotExist) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&criteria))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Criteria parameter must be array with one or more attributes of the model", "phalconator/Mvc/Collection.zep", 291);
		return;
	}
	ZEPHIR_CALL_METHOD(&collection, this_ptr, "preparecu", NULL, 0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&keys, "array_flip", NULL, 3, &criteria);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&data, this_ptr, "toarray", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "array_diff_key", NULL, 4, &keys, &data);
	zephir_check_call_status();
	if (UNEXPECTED(zephir_is_true(&_5))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Criteria parameter must be array with one or more attributes of the model", "phalconator/Mvc/Collection.zep", 329);
		return;
	}
	ZEPHIR_CALL_FUNCTION(&query, "array_intersect_key", NULL, 5, &data, &keys);
	zephir_check_call_status();
	success = 0;
	ZEPHIR_INIT_VAR(&_6);
	...
	if (Z_TYPE_P(&status) == IS_NULL) {
		...
		if (Z_TYPE_P(&doc) == IS_ARRAY) {
			...
			zephir_array_fetch_string(&_10$$7, &doc, SL("_id"), PH_NOISY | PH_READONLY, "phalconator/Mvc/Collection.zep", 358 TSRMLS_CC);
			zephir_update_property_zval(this_ptr, SL("_id"), &_10$$7);
		}
	} else {
		ZEPHIR_INIT_VAR(&_11$$8);
		object_init_ex(&_11$$8, zephir_get_internal_ce(SL("phalcon\\messages\\message")));
	...
	zephir_read_static_property_ce(&_8, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (success) {
		ZVAL_BOOL(&_13, 1);
	} else {
		ZVAL_BOOL(&_13, 0);
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 2, &_8, &_13, &_14);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalconator_Mvc_Collection, delete) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval __$true, __$false, disableEvents, status, id, connection, source, collection, objectId, _0, _7, _8, _1$$4, _2$$4, _3$$9, _4$$9, _9$$14, _10$$13;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(!(zephir_fetch_property(&id, this_ptr, SL("_id"), PH_SILENT_CC)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "The document cannot be deleted because it doesn't exist", "phalconator/Mvc/Collection.zep", 419);
		return;
	}
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_static_property_ce(&_0, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC);
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Method getSource() returns empty string", "phalconator/Mvc/Collection.zep", 442);
		return;
	}
	...
	if (zephir_is_true(&_8)) {
		...
		ZVAL_LONG(&_10$$13, 2);
		zephir_update_property_zval(this_ptr, SL("dirtyState"), &_10$$13);
	} else {
		success = 0;
	}
...
PHP_METHOD(Phalconator_Mvc_Collection, getReservedAttributes) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_static_property_ce(&_0, phalconator_mvc_collection_ce, SL("reserved"), PH_NOISY_CC);
	if (Z_TYPE_P(&_0) != IS_ARRAY) {
		...
		zend_update_static_property(phalconator_mvc_collection_ce, ZEND_STRL("reserved"), &_1$$3);
	}
	zephir_read_static_property_ce(&_2, phalconator_mvc_collection_ce, SL("reserved"), PH_NOISY_CC | PH_READONLY);
	RETURN_CTOR(&_2);
...
PHP_METHOD(Phalconator_Mvc_Collection, save) {
	...
	zval _13$$8;
	zval _7$$6, _8$$7, _10$$7, _11$$7;
	zend_bool success = 0;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, exists, data, status, collection, _2, _3, _4, _5, _6, _14, _17, _18, _0$$3, _1$$4, _9$$7, _12$$8, _15$$10, _16$$10;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_read_static_property_ce(&_5, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "presave", NULL, 1, &_4, &_5, &exists);
	zephir_check_call_status();
	...
	success = 0;
	ZEPHIR_OBS_VAR(&_6);
	zephir_read_property(&_6, this_ptr, SL("operationMade"), PH_NOISY_CC);
	do {
		if (ZEPHIR_IS_LONG(&_6, 1)) {
			ZEPHIR_INIT_VAR(&_7$$6);
			zephir_create_array(&_7$$6, 1, 0 TSRMLS_CC);
			zephir_array_update_string(&_7$$6, SL("w"), &__$true, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_METHOD(&status, &collection, "insertone", NULL, 0, &data, &_7$$6);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&_6, 2)) {
			...
			ZEPHIR_OBS_VAR(&_9$$7);
			zephir_read_property(&_9$$7, this_ptr, SL("_id"), PH_NOISY_CC);
			zephir_array_update_string(&_8$$7, SL("_id"), &_9$$7, PH_COPY | PH_SEPARATE);
			ZEPHIR_INIT_VAR(&_10$$7);
			zephir_create_array(&_10$$7, 1, 0 TSRMLS_CC);
			zephir_array_update_string(&_10$$7, SL("$set"), &data, PH_COPY | PH_SEPARATE);
			ZEPHIR_INIT_VAR(&_11$$7);
			zephir_create_array(&_11$$7, 1, 0 TSRMLS_CC);
			zephir_array_update_string(&_11$$7, SL("w"), &__$true, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_METHOD(&status, &collection, "updateone", NULL, 0, &_8$$7, &_10$$7, &_11$$7);
			zephir_check_call_status();
			break;
		}
		ZEPHIR_INIT_VAR(&_12$$8);
		object_init_ex(&_12$$8, zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")));
		ZEPHIR_INIT_VAR(&_13$$8);
		ZEPHIR_CONCAT_SS(&_13$$8, "Invalid operation requested for ", "Collection:save");
		ZEPHIR_CALL_METHOD(NULL, &_12$$8, "__construct", NULL, 0, &_13$$8);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_12$$8, "phalconator/Mvc/Collection.zep", 931 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);

	ZEPHIR_CALL_METHOD(&_14, &status, "isacknowledged", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_14)) {
		success = 1;
		if (ZEPHIR_IS_FALSE_IDENTICAL(&exists)) {
			ZEPHIR_CALL_METHOD(&_15$$10, &status, "getinsertedid", NULL, 0);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, SL("_id"), &_15$$10);
			ZEPHIR_INIT_ZVAL_NREF(_16$$10);
			ZVAL_LONG(&_16$$10, 0);
			zephir_update_property_zval(this_ptr, SL("dirtyState"), &_16$$10);
		}
	}
	zephir_read_static_property_ce(&_17, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (success) {
		ZVAL_BOOL(&_18, 1);
	} else {
		ZVAL_BOOL(&_18, 0);
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 2, &_17, &_18, &exists);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalconator_Mvc_Collection, serialize) {
	...
	zend_class_entry *_0;
	zval container, serializer, _1, _2, _7, _3$$4, _4$$4, _5$$4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	ZEPHIR_CALL_CE_STATIC(&container, _0, "getdefault", NULL, 0);
	zephir_check_call_status();
	if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "The dependency injector container is not valid", "phalconator/Mvc/Collection.zep", 967);
		return;
	}
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(Phalconator_Mvc_Collection, toArray) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&_0, 0, "phalconator/Mvc/Collection.zep", 1100);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
...
PHP_METHOD(Phalconator_Mvc_Collection, unserialize) {
	...
	zend_string *_14$$6;
	zend_ulong _13$$6;
	zend_class_entry *_0, *_3$$3;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_5 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *data, data_sub, attributes, container, manager, key, value, serializer, _6, _7, _1$$3, _2$$3, _4$$3, _8$$4, _9$$4, _10$$6, *_11$$6, _12$$6;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
		ZEPHIR_INIT_VAR(&_1$$3);
		object_init_ex(&_1$$3, zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")));
		_3$$3 = zephir_fetch_class_str_ex(SL("Phalcon\\Mvc\\Collection\\Exception"), ZEND_FETCH_CLASS_AUTO);
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "the services related to the ODM");
		ZEPHIR_CALL_CE_STATIC(&_2$$3, _3$$3, "containerservicenotfound", NULL, 0, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", &_5, 0, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalconator/Mvc/Collection.zep", 1119 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_update_property_zval(this_ptr, SL("container"), &container);
	ZEPHIR_INIT_VAR(&_7);
	ZVAL_STRING(&_7, "serializer");
	ZEPHIR_CALL_METHOD(&_6, &container, "has", NULL, 0, &_7);
	zephir_check_call_status();
	if (zephir_is_true(&_6)) {
		ZEPHIR_INIT_VAR(&_9$$4);
		ZVAL_STRING(&_9$$4, "serializer");
		ZEPHIR_CALL_METHOD(&_8$$4, &container, "getshared", NULL, 0, &_9$$4);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&serializer, &_8$$4);
		ZEPHIR_CALL_METHOD(&attributes, &serializer, "unserialize", NULL, 0, data);
		zephir_check_call_status();
	} else {
		ZEPHIR_CALL_FUNCTION(&attributes, "unserialize", NULL, 8, data);
		zephir_check_call_status();
	}
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&_10$$6);
		ZVAL_STRING(&_10$$6, "collectionManager");
		ZEPHIR_CALL_METHOD(&manager, &container, "getshared", NULL, 0, &_10$$6);
		zephir_check_call_status();
		if (UNEXPECTED(Z_TYPE_P(&manager) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "The injected service 'collectionManager' is not valid", "phalconator/Mvc/Collection.zep", 1143);
			return;
		}
		zephir_update_property_zval(this_ptr, SL("modelsManager"), &manager);
		zephir_is_iterable(&attributes, 0, "phalconator/Mvc/Collection.zep", 1157);
		if (Z_TYPE_P(&attributes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&attributes), _13$$6, _14$$6, _11$$6)
			{
				ZEPHIR_INIT_NVAR(&key);
				if (_14$$6 != NULL) { 
					ZVAL_STR_COPY(&key, _14$$6);
				} else {
					ZVAL_LONG(&key, _13$$6);
				}
				ZEPHIR_INIT_NVAR(&value);
				ZVAL_COPY(&value, _11$$6);
			...
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_12$$6, &attributes, "valid", NULL, 0);
				zephir_check_call_status();
...
PHP_METHOD(Phalconator_Mvc_Collection, update) {
	...
	zend_bool success = 0;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, exists, data, status, collection, _0, _1, _2, _3, _5, _8, _9, _10;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(!zephir_is_true(&exists))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "The document cannot be updated because it doesn't exist", "phalconator/Mvc/Collection.zep", 1178);
		return;
	}
	ZEPHIR_INIT_ZVAL_NREF(_0);
	ZVAL_LONG(&_0, 2);
	...
	zephir_read_property(&_0, this_ptr, SL("container"), PH_NOISY_CC | PH_READONLY);
	zephir_read_static_property_ce(&_3, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "presave", NULL, 1, &_0, &_3, &exists);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_2)) {
		RETURN_MM_BOOL(0);
	}
	...
	ZEPHIR_INIT_VAR(&_6);
	zephir_create_array(&_6, 1, 0 TSRMLS_CC);
	zephir_array_update_string(&_6, SL("$set"), &data, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(&_7);
	zephir_create_array(&_7, 1, 0 TSRMLS_CC);
	zephir_array_update_string(&_7, SL("w"), &__$true, PH_COPY | PH_SEPARATE);
	ZEPHIR_CALL_METHOD(&status, &collection, "updateone", NULL, 0, &_4, &_6, &_7);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_8, &status, "isacknowledged", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_8)) {
	...
	zephir_read_static_property_ce(&_9, phalconator_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (success) {
		ZVAL_BOOL(&_10, 1);
	} else {
		ZVAL_BOOL(&_10, 0);
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 2, &_9, &_10, &exists);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalconator_Mvc_Collection, validate) {
	...
	for (;_1->funcs->valid(_1 TSRMLS_CC) == SUCCESS && !EG(exception); _1->funcs->move_forward(_1 TSRMLS_CC)) {
		...
		object_init_ex(&_2$$4, zephir_get_internal_ce(SL("phalcon\\messages\\message")));
 ...
 */
PHP_METHOD(Phalconator_Mvc_Collection, cancelOperation) {
 ...
 */
PHP_METHOD(Phalconator_Mvc_Collection, exists) {
 ...
 */
PHP_METHOD(Phalconator_Mvc_Collection, getGroupResultset) {

	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *params, params_sub, *collection, collection_sub, *connection, connection_sub, source, mongoCollection, conditions;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Method getSource() returns empty string", "phalconator/Mvc/Collection.zep", 1386);
		return;
	}
 ...
 * @return array
 */
PHP_METHOD(Phalconator_Mvc_Collection, getResultset) {
	...
	zval *params, params_sub, *collection, collection_sub, *connection, connection_sub, *unique_param = NULL, source, mongoCollection, conditions, base, documentsCursor, document, className, _0$$3, _3$$4, _4$$4, _6$$6, _8$$12;
	zval *this_ptr = getThis();
	...
	if (zephir_array_isset_string_fetch(&className, params, SL("class"), 0)) {
		...
		if (UNEXPECTED(!(_2$$3))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_3$$4, "phalconator/Mvc/Collection.zep", 1424 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else {
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Method getSource() returns empty string", "phalconator/Mvc/Collection.zep", 1438);
		return;
	}
	ZEPHIR_CALL_METHOD(&mongoCollection, connection, "selectcollection", NULL, 0, &source);
	zephir_check_call_status();
	if (UNEXPECTED(Z_TYPE_P(&mongoCollection) != IS_OBJECT)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Couldn't select mongo collection", "phalconator/Mvc/Collection.zep", 1444);
		return;
	}
	ZEPHIR_OBS_VAR(&conditions);
	if (!(zephir_array_isset_long_fetch(&conditions, params, 0, 0 TSRMLS_CC))) {
	...
	if (UNEXPECTED(Z_TYPE_P(&conditions) != IS_ARRAY)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Find parameters must be an array", "phalconator/Mvc/Collection.zep", 1457);
		return;
	}
	if (!(zephir_array_isset_string(params, SL("typeMap")))) {
		ZEPHIR_INIT_VAR(&_7$$12);
		zephir_create_array(&_7$$12, 2, 0 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_8$$12);
		zephir_get_class(&_8$$12, &base, 0 TSRMLS_CC);
		zephir_array_update_string(&_7$$12, SL("root"), &_8$$12, PH_COPY | PH_SEPARATE);
		add_assoc_stringl_ex(&_7$$12, SL("document"), SL("array"));
		zephir_array_update_string(params, SL("typeMap"), &_7$$12, PH_COPY | PH_SEPARATE);
	}
	if (unique) {
		...
		if ((zephir_method_exists_ex(&base, SL("afterfetch") TSRMLS_CC) == SUCCESS)) {
			ZEPHIR_CALL_METHOD(NULL, &base, "afterfetch", NULL, 0);
			zephir_check_call_status();
		}
 ...
 */
PHP_METHOD(Phalconator_Mvc_Collection, preSave) {

	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_2 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool disableEvents, exists;
	zval *container, container_sub, *disableEvents_param = NULL, *exists_param = NULL, __$true, __$false, eventName, _4, _5, _0$$3, _1$$3, _3$$3, _6$$9, _7$$10, _8$$10, _9$$10, _10$$10, _11$$10, _12$$10;
	zval *this_ptr = getThis();
	...
	if (!(disableEvents)) {
		...
		zephir_read_property(&_12$$10, this_ptr, SL("skipped"), PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_IS_TRUE_IDENTICAL(&_12$$10)) {
			RETURN_MM_BOOL(1);
		}
	}
	RETURN_MM_BOOL(1);
 ...
 */
PHP_METHOD(Phalconator_Mvc_Collection, postSave) {

	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_1 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *disableEvents_param = NULL, *success_param = NULL, *exists_param = NULL, eventName, _0$$4, _2$$3, _3$$5;
	...
	if (!(success)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "canceloperation", NULL, 0, &_2$$3);
		zephir_check_call_status();
		RETURN_MM_BOOL(0);
	}
	if (!(disableEvents)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "fireevent", &_1, 0, &eventName);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_3$$5);
		ZVAL_STRING(&_3$$5, "afterSave");
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "fireevent", &_1, 0, &_3$$5);
		zephir_check_call_status();
	}
	RETURN_MM_BOOL(success);
...
PHP_METHOD(Phalconator_Mvc_Collection, prepareCU) {
	...
	if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", &_5, 0, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalconator/Mvc/Collection.zep", 1630 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&source, this_ptr, "getsource", NULL, 0);
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "Method getSource() returns empty string", "phalconator/Mvc/Collection.zep", 1635);
		return;
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getconnection", NULL, 0);
	zephir_check_call_status();
...
PHP_METHOD(Phalconator_Mvc_Collection, bsonUnserialize) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *data_param = NULL, container, manager, key, value, _1, *_2, _3;
	zval data;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	if (Z_TYPE_P(&container) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\exception")), "A dependency injector container is required to obtain the services related to the ORM", "phalconator/Mvc/Collection.zep", 1660);
		return;
	}
	zephir_update_property_zval(this_ptr, SL("container"), &container);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "collectionManager");
	ZEPHIR_CALL_METHOD(&manager, &container, "getshared", NULL, 0, &_1);
	zephir_check_call_status();
	...
	zephir_update_property_zval(this_ptr, SL("modelsManager"), &manager);
	zephir_is_iterable(&data, 0, "phalconator/Mvc/Collection.zep", 1685);
