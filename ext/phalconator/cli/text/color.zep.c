...
PHP_METHOD(Phalconator_Cli_Text_Color, render) {
	...
	if (ZEPHIR_IS_EMPTY(&data)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalconator_cli_exception_ce, "Data is required", "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 89);
		return;
	}
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalconator_cli_exception_ce, "Bad color type", "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 93);
		return;
	}
	...
	if (_1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalconator_cli_exception_ce, "Bad background type", "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 97);
		return;
	}
	...
	if (_2) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalconator_cli_exception_ce, "Bad style type", "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 101);
		return;
	}
...
PHP_METHOD(Phalconator_Cli_Text_Color, _concat) {
	...
	if (zephir_array_isset_fetch(&co, &_0, color, 0 TSRMLS_CC)) {
		zephir_array_append(&concat, &co, PH_SEPARATE, "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 134);
	}
	ZEPHIR_OBS_VAR(&st);
	...
	if (zephir_array_isset_fetch(&st, &_1, style, 0 TSRMLS_CC)) {
		zephir_array_append(&concat, &st, PH_SEPARATE, "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 138);
	}
	ZEPHIR_OBS_VAR(&bg);
	...
	if (zephir_array_isset_fetch(&bg, &_2, background, 0 TSRMLS_CC)) {
		zephir_array_append(&concat, &bg, PH_SEPARATE, "/var/www/html/src/modules/Phalconator/phalconator/cli/text/color.zep", 142);
	}
	ZEPHIR_INIT_VAR(&_3);
